...
## Acceptance Criteria
- [x] Source folder picker button opens native folder dialog
- [x] Destination folder picker button opens native folder dialog
- [x] Selected paths are displayed in the UI
- [x] Actions (Preview, Dry Run, Copy) are disabled when source or destination is not set
- [x] Same folder chosen for source and destination shows a warning and blocks operations
- [x] Inline message shown when source or destination is missing
...
## Testing
- [x] Folder picker opens and returns path
- [x] Both paths displayed after selection
- [x] Actions disabled when paths missing
- [x] Same-folder warning shown
