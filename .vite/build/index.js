...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  getRobocopyThreads: () => electron.ipcRenderer.invoke("getRobocopyThreads"),
  setRobocopyThreads: (args) => electron.ipcRenderer.invoke("setRobocopyThreads", args),
  getScannerThreads: () => electron.ipcRenderer.invoke("getScannerThreads"),
  setScannerThreads: (args) => electron.ipcRenderer.invoke("setScannerThreads", args),
  getLastUsedPaths: () => electron.ipcRenderer.invoke("getLastUsedPaths"),
  setLastUsedPaths: (args) => electron.ipcRenderer.invoke("setLastUsedPaths", args),
